...
import fun.rich.client.feature.impl.visual.SwingAnimations;
import fun.rich.client.feature.impl.visual.ViewModel;
...
public class ItemRenderer {
    ...
    private void transformEatFirstPerson(float p_187454_1_, EnumHandSide p_187454_2_, ItemStack p_187454_3_) {
        ...
        if (Rich.instance.featureManager.getFeature(ViewModel.class).isEnabled()) {
    ...
    private void transformFirstPerson(EnumHandSide p_187453_1_, float p_187453_2_) {
        float angle = System.currentTimeMillis() / (long) ((int) SwingAnimations.item360Speed.getNumberValue()) % 360L;
        ...
        if (Rich.instance.featureManager.getFeature(SwingAnimations.class).isEnabled() && SwingAnimations.item360.getBoolValue()) {
    ...
    private void transformFirstPersonItem(final float equipProgress, final float swingProgress) {
        ...
        GlStateManager.translate(SwingAnimations.rightx1.getNumberValue(), SwingAnimations.righty2.getNumberValue(), SwingAnimations.rightz3.getNumberValue());
        ...
        if (!Config.isShaders() || !Shaders.isSkipRenderHand(p_187457_4_)) {
            ...
            if (p_187457_6_.func_190926_b()) {
                ...
                if (p_187457_1_.isHandActive() && p_187457_1_.getItemInUseCount() > 0 && p_187457_1_.getActiveHand() == p_187457_4_) {
                    ...
                    if (Rich.instance.featureManager.getFeature(SwingAnimations.class).isEnabled() && !SwingAnimations.auraOnly.getBoolValue() || Rich.instance.featureManager.getFeature(KillAura.class).isEnabled() && KillAura.target != null) {
                        if (Rich.instance.featureManager.getFeature(SwingAnimations.class).isEnabled() && !SwingAnimations.auraOnly.getBoolValue() || Rich.instance.featureManager.getFeature(KillAura.class).isEnabled() && KillAura.target != null) {
                            if (enumhandside != (this.mc.gameSettings.mainHand.equals(EnumHandSide.LEFT) ? EnumHandSide.RIGHT : EnumHandSide.LEFT)) {
                                if (mode.equalsIgnoreCase("Default")) {
                                ...
                                } else if (mode.equalsIgnoreCase("Swipe")) {
                                    ...
                                    this.spin += 1.0f;
                                } else if (mode.equalsIgnoreCase("Rich")) {
                                    this.transformFirstPersonItem(0, 0);
                                    translate4();
    ...
    public void renderOverlays(float partialTicks) {
        ...
        if (!this.mc.player.isSpectator()) {
            ...
            if (!Rich.instance.featureManager.getFeature(NoOverlay.class).isEnabled() && !NoOverlay.noFire.getBoolValue()) {
