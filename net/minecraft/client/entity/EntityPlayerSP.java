...
import fun.rich.client.feature.impl.player.NoSlowDown;
import fun.rich.client.feature.impl.visual.DamageParticles;
...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    public void onUpdate() {
        ...
        if (this.world.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ))) {
            ...
            if (this.isRiding()) {
                ...
                if (!Rich.instance.featureManager.getFeature(FreeCam.class).isEnabled()) {
    ...
    protected boolean pushOutOfBlocks(double x, double y, double z) {
        ...
        if (Rich.instance.featureManager.getFeature(NoPush.class).isEnabled() && NoPush.blocks.getBoolValue() || Rich.instance.featureManager.getFeature(FreeCam.class).isEnabled() || Rich.instance.featureManager.getFeature(NoClip.class).isEnabled())
            return false;
    ...
    public void onCriticalHit(Entity entityHit) {
        if(!Rich.instance.featureManager.getFeature(DamageParticles.class).isEnabled()) {
    ...
    public void onLivingUpdate() {
        ...
        if (this.isHandActive() && !this.isRiding()) {
            this.movementInput.moveStrafe *= Rich.instance.featureManager.getFeature(NoSlowDown.class).isEnabled() ? NoSlowDown.percentage.getNumberValue() / 100 : 0.2F;
            this.movementInput.moveForward *= Rich.instance.featureManager.getFeature(NoSlowDown.class).isEnabled() ? NoSlowDown.percentage.getNumberValue() / 100 : 0.2F;
