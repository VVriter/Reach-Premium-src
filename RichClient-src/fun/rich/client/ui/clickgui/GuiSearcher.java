        ...
        if (this.getVisible()) {
            if (this.getEnableBackgroundDrawing()) {
                RenderUtils.drawShadow(5, 1, () -> {
                    RenderUtils.drawRect(this.xPosition, this.yPosition, this.xPosition + this.width, this.yPosition + this.height, new Color(30, 30, 30, 255).getRGB());
                });
            ...
            if (!s.isEmpty()) {
                ...
                j1 = (int) Minecraft.getMinecraft().rubik_18.drawStringWithShadow(s1, l, i1, i);
            }
            ...
            if (!s.isEmpty() && flag && j < s.length()) {
                j1 = (int) Minecraft.getMinecraft().rubik_18.drawStringWithShadow(s.substring(j), j1, i1, i);
            }
            if (flag1) {
                if (flag2) {
                    Gui.drawRect(k1, i1 - 1, k1 + 1, i1 + 1 + Minecraft.getMinecraft().rubik_18.getFontHeight(), -3092272);
                } else {
                    Minecraft.getMinecraft().rubik_18.drawStringWithShadow("_", k1, i1, i);
                }
            }
            if (k != j) {
                int l1 = l + Minecraft.getMinecraft().rubik_18.getStringWidth(s.substring(0, k));
                this.drawCursorVertical(k1, i1 - 1, l1 - 1, i1 + 1 + Minecraft.getMinecraft().rubik_18.getFontHeight());
            }
        }
    }
