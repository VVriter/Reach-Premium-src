...
public class AutoArmor extends Feature {
    ...
    public AutoArmor() {
        super("AutoArmor", "Автоматически одевает броню", FeatureCategory.Combat);
        delay = new NumberSetting("Equip Delay", 1, 0, 10, 1, () -> true);
        openInventory = new BooleanSetting("Only Open Inventory", "Только при открытом инвинтаре ",true, () -> true);
