...
public class Hud extends Feature {
    ...
    public Hud() {
        ...
        addSettings(waterMark, waterMarkMode, sessionInfo, indicators, potions, coords, user_info);
    }
    ...
    public void onRender(EventRender2D eventRender2D) {
        if (waterMark.getBoolValue()) {
            if (waterMarkMode.currentMode.equals("Simple")) {
                ...
                Minecraft.getMinecraft().rubik_30.drawStringWithFade("Rich Premium", dwm.getX() + 3, dwm.getY() + 3);
                ...
                String str = UserData.instance().getName();
                String dateFormat = new SimpleDateFormat("HH:mm:ss").format(Calendar.getInstance().getTime());
                String text = "richclient.fun | " + str + " | " + server + " | FPS: " + Minecraft.getDebugFPS() + " | " + dateFormat;
                ...
                String text = UserData.instance().getName() + ChatFormatting.GRAY + " | " + ChatFormatting.RESET + Minecraft.getDebugFPS() + " fps" + ChatFormatting.GRAY + " | " + ChatFormatting.RESET + server + ChatFormatting.GRAY + " | " + ChatFormatting.RESET + formater.format(date);
                String scam = "RICH PREMIUM | " + UserData.instance().getName() + " | " + Minecraft.getDebugFPS() + " fps" + " | " + server + " | " + ChatFormatting.RESET + formater.format(date);
                ...
                Minecraft.getMinecraft().neverlose900_15.drawString("RICH PREMIUM", dwm.getX() + 7.5F, dwm.getY() + 10, new Color(22, 97, 141).getRGB());
                Minecraft.getMinecraft().neverlose900_15.drawString("RICH PREMIUM", dwm.getX() + 8F, dwm.getY() + 10.5F, -1);
                Minecraft.getMinecraft().rubik_14.drawString(ChatFormatting.GRAY + " | " + TextFormatting.RESET + text, dwm.getX() + 7 + Minecraft.getMinecraft().rubik_14.getStringWidth("RICH PREMIUM | "), dwm.getY() + 10.5f, -1);
                GLUtils.INSTANCE.rescaleMC();
                ...
                GLUtils.INSTANCE.rescale(scale);
                String server = mc.isSingleplayer() ? "local" : mc.getCurrentServerData() != null ? mc.getCurrentServerData().serverIP.toLowerCase() : "null";
                String scam = "richclient.fun" + TextFormatting.GRAY + " | " + TextFormatting.RESET + UserData.instance().getName() + TextFormatting.GRAY + " | " + TextFormatting.RESET + server + TextFormatting.GRAY + " | " + TextFormatting.RESET + Minecraft.getDebugFPS() + "fps";

                String text = TextFormatting.GRAY + "  | " + TextFormatting.RESET + UserData.instance().getName() + TextFormatting.GRAY + " | " + TextFormatting.RESET + server + TextFormatting.GRAY + " | " + TextFormatting.RESET + Minecraft.getDebugFPS() + "fps";
                ...
                Minecraft.getMinecraft().rubik_14.drawStringWithShadow("richclient.fun", dwm.getX() + 11, dwm.getY() + 13f, -1);

                Minecraft.getMinecraft().rubik_15.drawString(text, dwm.getX() + 10 + Minecraft.getMinecraft().rubik_14.getStringWidth("richclient.fun"), dwm.getY() + 13, -1);
        ...
        if (user_info.getBoolValue()) {
            ...
            dci.setHeight(18);
            GLUtils.INSTANCE.rescale(scale);
            String buildStr = ChatFormatting.GRAY + "Version - " + ChatFormatting.WHITE + Rich.instance.version + ChatFormatting.WHITE + " |" + ChatFormatting.GRAY + " Username - " + ChatFormatting.WHITE + UserData.instance().getName();
