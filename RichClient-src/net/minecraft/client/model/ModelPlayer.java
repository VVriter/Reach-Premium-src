...
public class ModelPlayer extends ModelBiped {
    ...
    public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
        ...
        if ((!CustomModel.onlyMe.getBoolValue() || entityIn == (Minecraft.getMinecraft()).player || (Rich.instance.friendManager.isFriend(entityIn.getName()) && CustomModel.friends.getBoolValue())) && !CustomModel.modelMode.currentMode.equals("None") && Rich.instance.featureManager.getFeature(CustomModel.class).isEnabled()) {
            if (CustomModel.modelMode.currentMode.equals("Amogus")) {
                ...
                int bodyCustomColor = CustomModel.bodyCustomColor.getColorValue();
                int bodyColor = 0;
                switch (CustomModel.bodyColor.currentMode) {
                    ...
                    case "Custom":
                        ...
                        break;
                    case "Astolfo":
                        bodyColor = ColorUtils.astolfoColors(5000.0F, 1).getRGB();
                        break;
                    case "Rainbow":
                        bodyColor = ColorUtils.rainbow(30, 1.0F, 1.0F).getRGB();
                        break;
                }
                int eyeCustomColor = CustomModel.eyeCustomColor.getColorValue();
                int eyeColor = 0;
                switch (CustomModel.eyeColor.currentMode) {
                    ...
                    case "Custom":
                        ...
                        break;
                    case "Astolfo":
                        eyeColor = ColorUtils.astolfoColors(5000.0F, 1).getRGB();
                        break;
                    case "Rainbow":
                        eyeColor = ColorUtils.rainbow(30, 1.0F, 1.0F).getRGB();
                        break;
                }
                int legsCustomColor = CustomModel.legsCustomColor.getColorValue();
                int legsColor = 0;
                switch (CustomModel.legsColor.currentMode) {
                    ...
                    case "Custom":
                        ...
                        break;
                    case "Astolfo":
                        legsColor = ColorUtils.astolfoColors(5000.0F, 1).getRGB();
                        break;
                    case "Rainbow":
                        legsColor = ColorUtils.rainbow(30, 1.0F, 1.0F).getRGB();
                        break;
                }
                if (CustomModel.friendHighlight.getBoolValue() && Rich.instance.friendManager.isFriend(entityIn.getName())) {
                ...
                if (this.isChild) {
                    ...
                    RenderUtils.color(bodyColor);
                    GlStateManager.translate(0.0D, 0.15D, 0.0D);
                    this.body.render(scale);
                    RenderUtils.color(eyeColor);
                    this.eye.render(scale);
                    RenderUtils.color(legsColor);
                    GlStateManager.translate(0.0D, -0.15D, 0.0D);
                    this.left_leg.render(scale);
                    this.right_leg.render(scale);
                    GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
                }
            } else if (Rich.instance.featureManager.getFeature(CustomModel.class).isEnabled() && CustomModel.modelMode.currentMode.equals("Jeff Killer")) {
            ...
            } else if (Rich.instance.featureManager.getFeature(CustomModel.class).isEnabled() && CustomModel.modelMode.currentMode.equals("Demon")) {
    ...
    public void renderCape(float scale) {
        if (!Rich.instance.featureManager.getFeature(CustomModel.class).isEnabled() || (!CustomModel.modelMode.currentMode.equals("Werewolf") && !CustomModel.modelMode.currentMode.equals("Rabbit") && !CustomModel.modelMode.currentMode.equals("Sonic") && !CustomModel.modelMode.currentMode.equals("CupHead") && !CustomModel.modelMode.currentMode.equals("Chinchilla") && !CustomModel.modelMode.currentMode.equals("Freddy Bear") && !CustomModel.modelMode.currentMode.equals("Amogus") && !CustomModel.modelMode.currentMode.equals("Demon") && !CustomModel.modelMode.currentMode.equals("Red Panda") && !CustomModel.modelMode.currentMode.equals("Crab") && !CustomModel.modelMode.currentMode.equals("Jeff Killer")))
