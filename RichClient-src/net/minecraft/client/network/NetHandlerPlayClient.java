...
import fun.rich.client.feature.impl.combat.Velocity;
...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
    ...
    public void handleJoinGame(SPacketJoinGame packetIn) {
        ...
        RespawnEvent event = new RespawnEvent();
    ...
    public void handleEntityVelocity(SPacketEntityVelocity packetIn) {
        ...
        if (entity != null) {
            if (Velocity.velocityMode.currentMode.equals("Matrix") && Rich.instance.featureManager.getFeature(Velocity.class).isEnabled()) {
    ...
    public void onDisconnect(ITextComponent reason) {
        ...
        if (this.guiScreenServer != null) {
            ...
            this.gameController.displayGuiScreen(new GuiDisconnected(new GuiMultiplayer(new RichMainMenu()), "disconnect.lost", reason));
        }
    }
