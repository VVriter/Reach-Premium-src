...
public class ESPUtil implements Helper {
    ...
    public static double[] getInterpolatedPos(Entity entity) {
        ...
        return new double[]{
                MathematicHelper.interpolate(entity.lastTickPosX, entity.posX, ticks) - mc.getRenderManager().viewerPosX,
                MathematicHelper.interpolate(entity.lastTickPosY, entity.posY, ticks) - mc.getRenderManager().viewerPosY,
                MathematicHelper.interpolate(entity.lastTickPosZ, entity.posZ, ticks) - mc.getRenderManager().viewerPosZ
        };
    }
