package fun.rich.client.files.impl;

import fun.rich.client.Rich;
import fun.rich.client.command.macro.Macro;
        ...
        try {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (Rich.instance.macroManager != null) {
                    Rich.instance.macroManager.addMacro(new Macro(Keyboard.getKeyIndex(bind), value));
                }
            }
            br.close();
        } catch (Exception e) {
