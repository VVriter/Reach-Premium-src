...
public class BindCommand extends CommandAbstract {
    ...
    public BindCommand() {
        super("bind", "bind", "§6.bind" + ChatFormatting.RED + " add " + "§7<name> §7<key> " + TextFormatting.RED + "\n" + "[" + TextFormatting.WHITE + "Rich Premium" + TextFormatting.GRAY + "] " + "§6.bind " + ChatFormatting.RED + "remove " + "§7<name> §7<key> " + "\n" + "[" + TextFormatting.WHITE + "Rich Premium" + TextFormatting.GRAY + "] " + "§6.bind " + ChatFormatting.RED + "list ", "bind");
    }
